    ...
    return (
        <Animated.View style={[styles.toast, { opacity }]}>
            <View style={styles.toastContent}>
                ...
                <Pressable onPress={onDismiss} style={styles.toastClose}><Feather name="x" size={16} color="#fae9e9" /></Pressable>
            </View>
        ...
        <View style={styles.fieldBlock}>
            ...
            {selectedEmail ? (
                <Pressable style={styles.selectButton} onPress={() => setShowModal(true)}>
                    <Feather name="user" size={15} color="#fba8a0" />
                    ...
                    <KeyboardAvoidingView style={styles.bottomSheet} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                        <View style={styles.sheetCard}>
                            ...
                            <View style={styles.sheetSearchRow}>
                                ...
                                <TextInput style={styles.sheetSearchInput} onChangeText={setSearchValue} value={searchValue} placeholder="Search clients..." placeholderTextColor="#888" autoFocus />
                                <Pressable onPress={() => setShowModal(false)} hitSlop={10}><Feather name="x" size={18} color="#aaa" /></Pressable>
                            </View>
                    ...
                    <View style={styles.dateModalOverlay}>
                        <View style={styles.dateModalCard}>
                            <View style={styles.dateModalHeader}>
                                <Pressable onPress={prevM} style={styles.dateNavButton}><Feather name="chevron-left" size={22} color="#fae9e9" /></Pressable>
                                <Text style={styles.dateModalMonth}>{monthLabel(pYear,pMonth)}</Text>
                                <Pressable onPress={nextM} style={styles.dateNavButton}><Feather name="chevron-right" size={22} color="#fae9e9" /></Pressable>
                            </View>
...
const HistoryBanner = ({ history }) => {
    ...
    return (
        <View style={styles.historyBanner}>
            <Feather name="clock" size={12} color="#fba8a0" style={{marginRight:6}} />
...
const DropZone = ({ active }) => active ? <View style={styles.dropZone} /> : null;
            ...
            <View style={[styles.exerciseCard, isDragging && styles.exerciseCardDragging]}>
                <View style={styles.exerciseCardHeader}>
                    <Pressable style={styles.dragHandle} onLongPress={()=>onDragStart(sectionIndex,index)} delayLongPress={250} hitSlop={8}>
                        <Feather name="menu" size={16} color="#777" />
                    </Pressable>
                ...
                {loadingHistory && <View style={styles.histLoadRow}><ActivityIndicator size="small" color="#fba8a0" /><Text style={styles.histLoadText}>Loading history...</Text></View>}
                ...
                <View style={styles.setsRow}>
                    <View style={styles.setsField}>
                        ...
                        <TextInput style={styles.setsInput} keyboardType="numeric" placeholder="3" placeholderTextColor="#888"
                    ...
                    <View style={styles.setsField}>
                        ...
                        <TextInput style={[styles.setsInput,styles.setsInputOptional]} keyboardType="numeric" placeholder="opt." placeholderTextColor="#888"
                ...
                <Pressable style={styles.advancedToggle} onPress={()=>setShowAdvanced(v=>!v)}>
                    <Feather name={showAdvanced?'chevron-up':'chevron-down'} size={14} color="#aaa" />
                    ...
                    <View style={styles.advancedContainer}>
                        <View style={styles.advancedRow}>
                            <View style={styles.advancedField}>
                                ...
                                <TextInput style={styles.advancedInput} keyboardType="decimal-pad" placeholder="e.g. 7" placeholderTextColor="#888"
                            ...
                            <View style={styles.advancedField}>
                                ...
                                <TextInput style={styles.advancedInput} placeholder={history?.weight?`Last: ${history.weight}`:'e.g. 135 or 135–155'} placeholderTextColor="#888"
                ...
                <View style={styles.sectionCardHeader}>
                    ...
                    <View style={styles.sectionToggles}>
                        <Pressable style={[styles.toggleChip,section.timed&&styles.toggleChipActive]}
                            ...
                            <Feather name="clock" size={12} color={section.timed?'#7bb533':'#aaa'} />
                        ...
                        <Pressable style={[styles.toggleChip,section.circuit&&styles.toggleChipActive]}
                            ...
                            <Feather name="repeat" size={12} color={section.circuit?'#7bb533':'#aaa'} />
                ...
                {section.timed && (
                    <View style={styles.timedRestRow}>
                        <View style={styles.timedRestField}>
                            ...
                            <TextInput style={styles.timedRestInput} keyboardType="numeric" placeholder="e.g. 30" placeholderTextColor="#888"
                        ...
                        <View style={styles.timedRestField}>
                            ...
                            <TextInput style={styles.timedRestInput} keyboardType="numeric" placeholder="e.g. 90" placeholderTextColor="#888"
                    ...
                    {({ remove: removeEx, push: pushEx }) => (
                        <View>
                            ...
                            <Pressable style={styles.addExerciseButton} onPress={()=>pushEx(emptyExercise())}>
                                <Feather name="plus" size={15} color="#fba8a0" />
                        ...
                        return (
                            <View style={styles.formContainer}>
                                ...
                                <View style={styles.fieldBlock}>
                                    ...
                                    <TextInput style={styles.textInput} placeholder="e.g. Upper Body Strength" placeholderTextColor="#888"
                                    ...
                                    {({ remove, push }) => (
                                        <View>
                                            ...
                                            <Pressable style={styles.addSectionButton} onPress={()=>push({timed:false,circuit:true,data:[emptyExercise()]})}>
                                                <Feather name="plus-circle" size={18} color="#fba8a0" />
                                ...
                                {Object.keys(errors).length > 0 && (
                                    <View style={styles.validationSummary}>
                                        <Feather name="alert-circle" size={14} color="#fba8a0" style={{marginRight:8}} />
...
const styles = StyleSheet.create({
    ...
    // All label text #ccc or above for WCAG AA contrast on #000/#0d0d0d bg
    fieldBlock:    { marginBottom: 16 },
    fieldLabel:    { fontSize: 13, fontWeight: '600', color: '#ccc', textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 8 },
    req:           { color: '#fba8a0' },
    optionalLabel: { color: '#bbb', fontWeight: 'normal', textTransform: 'none', letterSpacing: 0, fontSize: 12 },
    inputLabel:    { fontSize: 11, fontWeight: '600', color: '#ccc', textTransform: 'uppercase', letterSpacing: 0.4, marginBottom: 4 },
    inputLabelSub: { textTransform: 'none', fontWeight: 'normal', color: '#bbb', letterSpacing: 0, fontSize: 10 },
    errorText:     { fontSize: 12, fontStyle: 'italic', color: '#fba8a0', marginTop: 4, paddingHorizontal: 2 },

    textInput: { backgroundColor: '#111', borderWidth: 1, borderColor: '#333', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontSize: 16, color: '#fae9e9' },

    selectButton:      { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#111', borderWidth: 1, borderColor: '#fba8a0', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12 },
    selectButtonText:  { flex: 1, fontSize: 15, color: '#fae9e9' },
    selectButtonEmpty: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#111', borderWidth: 1, borderColor: '#333', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12 },
    selectButtonEmptyText: { fontSize: 15, color: '#bbb' },

    bottomSheet:     { flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(0,0,0,0.6)' },
    sheetCard:       { backgroundColor: '#111', borderTopLeftRadius: 16, borderTopRightRadius: 16, maxHeight: '70%', paddingBottom: 40 },
    sheetHandle:     { width: 36, height: 4, backgroundColor: '#333', borderRadius: 2, alignSelf: 'center', marginTop: 10, marginBottom: 8 },
    sheetSearchRow:  { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 0.5, borderBottomColor: '#222' },
    sheetSearchInput:{ flex: 1, color: '#fae9e9', fontSize: 15 },
    clientRow:       { paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 0.5, borderBottomColor: '#1a1a1a' },
    clientName:      { fontSize: 15, color: '#fae9e9', fontWeight: '500' },
    clientEmail:     { fontSize: 12, color: '#ccc', marginTop: 2 },
    emptyListText:   { color: '#bbb', textAlign: 'center', padding: 30 },

    dateModalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'center', alignItems: 'center', padding: 16 },
    dateModalCard:    { backgroundColor: '#111', borderRadius: 12, width: '100%', borderWidth: 1, borderColor: '#222' },
    ...
    dateDayLabel:     { width: `${100/7}%`, textAlign: 'center', color: '#ccc', fontSize: 11, marginBottom: 4 },
    ...
    dateCellPastText: { color: '#999' },
    dateCellToday:    { color: '#fba8a0', fontWeight: 'bold' },
    dateCellOtherText:{ color: '#bbb' },
    dateClearButton:  { alignItems: 'center', paddingVertical: 8 },
    dateClearText:    { color: '#ccc', fontSize: 14 },
    dateCloseButton:  { margin: 16, backgroundColor: '#1a1a1a', borderRadius: 8, paddingVertical: 12, alignItems: 'center' },
    dateCloseText:    { color: '#fae9e9', fontSize: 15 },

    confirmOverlay:   { flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'center', alignItems: 'center', padding: 32 },
    confirmCard:      { backgroundColor: '#111', borderRadius: 12, padding: 24, width: '100%', borderWidth: 1, borderColor: '#222' },
    confirmTitle:     { fontSize: 17, fontWeight: '700', color: '#fae9e9', marginBottom: 8 },
    confirmMessage:   { fontSize: 14, color: '#ccc', marginBottom: 20, lineHeight: 20 },
    confirmActions:   { flexDirection: 'row', gap: 12 },
    confirmCancel:    { flex: 1, borderWidth: 1, borderColor: '#333', borderRadius: 8, paddingVertical: 12, alignItems: 'center' },
    confirmCancelText:{ color: '#ccc', fontSize: 15 },
    confirmConfirm:   { flex: 1, backgroundColor: 'rgba(251,168,160,0.12)', borderWidth: 1, borderColor: '#fba8a0', borderRadius: 8, paddingVertical: 12, alignItems: 'center' },
    confirmConfirmText:{ color: '#fba8a0', fontSize: 15, fontWeight: '600' },

    sectionCard:      { backgroundColor: '#0d0d0d', borderRadius: 12, borderWidth: 1, borderColor: '#222', marginBottom: 16, overflow: 'hidden' },
    sectionCardHeader:{ flexDirection: 'row', alignItems: 'center', padding: 14, borderBottomWidth: 0.5, borderBottomColor: '#222', gap: 8 },
    sectionBadge:     { backgroundColor: '#1a1a1a', borderRadius: 6, paddingHorizontal: 10, paddingVertical: 4 },
    sectionBadgeText: { color: '#ccc', fontSize: 12, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5 },
    sectionToggles:   { flexDirection: 'row', gap: 6, flex: 1 },
    toggleChip:       { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20, borderWidth: 1, borderColor: '#333' },
    toggleChipActive: { borderColor: '#7bb533', backgroundColor: 'rgba(123,181,51,0.1)' },
    toggleChipText:   { fontSize: 12, color: '#bbb' },
    toggleChipTextActive: { color: '#7bb533' },

    timedRestRow:   { flexDirection: 'row', gap: 12, padding: 14, borderBottomWidth: 0.5, borderBottomColor: '#222' },
    timedRestField: { flex: 1 },
    timedRestInput: { backgroundColor: '#1a1a1a', borderWidth: 1, borderColor: '#333', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8, fontSize: 15, color: '#fae9e9', textAlign: 'center' },

    exerciseCard:        { borderTopWidth: 0.5, borderTopColor: '#222', paddingHorizontal: 14, paddingTop: 12, paddingBottom: 8 },
    ...
    exerciseIndexBadge:  { width: 22, height: 22, borderRadius: 11, backgroundColor: '#1a1a1a', justifyContent: 'center', alignItems: 'center', flexShrink: 0 },
    exerciseIndexText:   { fontSize: 11, color: '#bbb', fontWeight: '700' },
    removeButton:        { padding: 6, borderRadius: 6, backgroundColor: '#1a1a1a', borderWidth: 1, borderColor: '#2a2a2a' },

    historyBanner:    { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(251,168,160,0.06)', borderWidth: 0.5, borderColor: 'rgba(251,168,160,0.2)', borderRadius: 6, paddingHorizontal: 10, paddingVertical: 6, marginBottom: 10 },
    historyBannerText:{ fontSize: 12, color: '#fba8a0', flex: 1 },
    histLoadRow:      { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 },
    histLoadText:     { fontSize: 12, color: '#ccc' },

    setsRow:         { flexDirection: 'row', alignItems: 'flex-end', gap: 6, marginBottom: 4 },
    setsField:       { width: 80 },
    setsInput:       { height: 40, backgroundColor: '#1a1a1a', borderWidth: 1, borderColor: '#333', borderRadius: 8, textAlign: 'center', fontSize: 15, color: '#fae9e9' },
    setsInputOptional:{ borderStyle: 'dashed', borderColor: '#2a2a2a', color: '#ccc' },
    setsDash:        { color: '#777', fontSize: 20, paddingBottom: 8, width: 16, textAlign: 'center' },
    countSection:    { marginTop: 4, marginBottom: 4 },

    advancedToggle:     { flexDirection: 'row', alignItems: 'center', gap: 6, paddingVertical: 8 },
    advancedToggleText: { fontSize: 12, color: '#bbb' },
    advancedDot:        { width: 6, height: 6, borderRadius: 3, backgroundColor: '#fba8a0' },
    advancedContainer:  { backgroundColor: '#111', borderRadius: 8, padding: 12, gap: 10, marginBottom: 8, borderWidth: 0.5, borderColor: '#222' },
    advancedRow:        { flexDirection: 'row', gap: 12 },
    advancedField:      { flex: 1 },
    advancedInput:      { backgroundColor: '#1a1a1a', borderWidth: 1, borderColor: '#333', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8, fontSize: 15, color: '#fae9e9', textAlign: 'center' },
    advancedNotesBlock: { gap: 6 },
    notesInput:         { backgroundColor: '#1a1a1a', borderWidth: 1, borderColor: '#333', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 13, color: '#fae9e9', minHeight: 72, textAlignVertical: 'top' },

    addExerciseButton:     { flexDirection: 'row', alignItems: 'center', gap: 6, paddingVertical: 12, marginHorizontal: 14, borderTopWidth: 0.5, borderTopColor: '#222' },
    addExerciseButtonText: { fontSize: 14, color: '#fba8a0', fontWeight: '600' },
    addSectionButton:      { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderWidth: 1, borderColor: '#fba8a0', borderStyle: 'dashed', borderRadius: 10, paddingVertical: 14, marginBottom: 12 },
    addSectionButtonText:  { fontSize: 15, color: '#fba8a0', fontWeight: '600' },

    dropZone:    { height: 3, backgroundColor: '#fba8a0', borderRadius: 2, marginHorizontal: 14, marginVertical: 2 },

    dragActiveBar:       { position: 'absolute', bottom: 0, left: 0, right: 0, flexDirection: 'row', alignItems: 'center', backgroundColor: '#fba8a0', paddingHorizontal: 16, paddingVertical: 12, gap: 8 },
    ...
    undoBar:        { position: 'absolute', bottom: 56, left: 16, right: 16, flexDirection: 'row', alignItems: 'center', backgroundColor: '#1a1a1a', borderWidth: 1, borderColor: '#fba8a0', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 10, gap: 10 },
    undoBarText:    { flex: 1, fontSize: 13, color: '#fae9e9', lineHeight: 18 },
    undoButton:     { paddingHorizontal: 12, paddingVertical: 6, backgroundColor: '#fba8a0', borderRadius: 6 },
    undoButtonText: { fontSize: 13, color: '#000', fontWeight: '700' },

    validationSummary:     { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(251,168,160,0.08)', borderWidth: 1, borderColor: 'rgba(251,168,160,0.3)', borderRadius: 8, padding: 12, marginBottom: 12 },
    validationSummaryText: { fontSize: 13, color: '#fba8a0', flex: 1 },

    saveButton:     { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, backgroundColor: '#7bb533', borderRadius: 12, paddingVertical: 16, marginTop: 8 },
    saveButtonText: { fontSize: 18, fontWeight: '700', color: '#000' },

    toast:        { position: 'absolute', top: 12, left: 16, right: 16, backgroundColor: '#1a1a1a', borderRadius: 10, borderWidth: 1, borderColor: '#7bb533', overflow: 'hidden', zIndex: 999, elevation: 10 },
